          ...
          <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
            <div class="card p-0">
              <div class="card-body p-0">
                @include('trainer.product.table-product')
              </div>
            </div>
          </div>
              ...
              <div class="card-header">
                ...
                <div class="card-body w-100">
                  <div class="table-responsive table-card">
                    <form action="{{url('trainer/product/update_cart')}}" method="post" class="cartform">
                      @include('trainer.product.table-cart')
                    </form>
                  </div>
                </div>
                @php
                ...
                <div class="card-footer justify-content-between d-flex">
                  ...
                  <div class="modal fade" id="exampleModal-2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <form action="{{url('trainer/product/pay')}}" class="eot" enctype="multipart/form-data" method="post" >
