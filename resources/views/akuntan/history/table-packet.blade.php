  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{url('akuntan/approved_payment_packet?id='.$row->id)}}" onclick="return confirm('Approve Transaksi ?')" class="btn btn-sm btn-success">Approve</a>
        @else
        ...
        <div class="modal fade" id="exampleModal-{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{url('akuntan/approved_payment_packet?id='.$row->id)}}" method="get" class="payment-{{$row->id}}">
