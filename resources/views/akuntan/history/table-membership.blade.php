@php
$memberships = \App\Models\Membership::whereStatus('pending')->latest()->get();
@endphp
<!-- basic table -->
<table class="table table-stripped mt-2">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{url('akuntan/approved_payment?id='.$row->id)}}" onclick="return confirm('Approve Transaksi ?')" class="btn btn-sm btn-success">Approve</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
