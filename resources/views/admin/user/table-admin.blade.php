@php
$users = \App\Models\User::whereRole('admin')->where('email', '<>', auth()->user()->email)->get();
@endphp
<!-- basic table -->
<table class="table table-stripped mt-2">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="{{url(auth()->user()->role.'/chat')}}?receiver_id={{$row->id}}" class="btn btn-warning btn-sm text-white">
